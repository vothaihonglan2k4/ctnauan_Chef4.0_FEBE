...
export default function ManagerLayout() {
    ...
    const navItems = [
        { path: '/manager', icon: 'fas fa-tachometer-alt', label: 'Dashboard', exact: true },
        { path: '/manager/recipes', icon: 'fas fa-utensils', label: 'Quản lý Công thức' },
        { path: '/manager/courses', icon: 'fas fa-graduation-cap', label: 'Quản lý Khóa học' },
        { path: '/manager/contacts', icon: 'fas fa-envelope', label: 'Liên hệ' },
        { path: '/manager/reports', icon: 'fas fa-chart-bar', label: 'Báo cáo' },
    ];
