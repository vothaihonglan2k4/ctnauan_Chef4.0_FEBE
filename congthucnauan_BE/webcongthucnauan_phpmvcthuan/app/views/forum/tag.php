    ...
    <div class="row">
        <div class="col-md-9">
            <h2 class="mb-4">
                ...
                Tag: <?php echo $data['current_tag']->name; ?>
            </h2>

            <?php if(!empty($data['posts'])): ?>
                <p class="text-muted"><?php echo count($data['posts']); ?> bài viết</p>
        ...
        <div class="col-md-3">
            ...
            <div class="card mb-3">
                <div class="card-header bg-light">
                    <h6 class="mb-0"><i class="fas fa-tags me-2"></i>Tags khác</h6>
                </div>
                <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <?php foreach($data['popular_tags'] as $tag): ?>
                                <a href="<?php echo URL_ROOT; ?>/forum/tag/<?php echo $tag->id; ?>" 
                                   class="badge bg-<?php echo ($tag->id == $data['current_tag']->id) ? 'primary' : 'secondary'; ?> text-decoration-none">
                                    <?php echo $tag->name; ?>
                                </a>
                            <?php endforeach; ?>
                        </div>
