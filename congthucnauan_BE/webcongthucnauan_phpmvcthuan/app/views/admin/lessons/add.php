        ...
        <div class="col-md-12 mb-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Thêm bài học mới</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-plus-circle"></i> Thông tin bài học
                </div>
                <div class="card-body">
                    <form action="<?php echo URL_ROOT; ?>/admin/add_lesson/<?php echo $data['course_id']; ?>" method="POST">
                        <div class="mb-3">
                            <label for="title" class="form-label">Tiêu đề bài học <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?php echo !empty($data['title_err']) ? 'is-invalid' : ''; ?>" id="title" name="title" value="<?php echo isset($data['title']) ? $data['title'] : ''; ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?php echo !empty($data['content_err']) ? 'is-invalid' : ''; ?>" id="content" name="content" rows="6"><?php echo isset($data['content']) ? $data['content'] : ''; ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control <?php echo !empty($data['video_url_err']) ? 'is-invalid' : ''; ?>" id="video_url" name="video_url" value="<?php echo isset($data['video_url']) ? $data['video_url'] : ''; ?>" placeholder="https://www.youtube.com/watch?v=..." required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control <?php echo !empty($data['duration_minutes_err']) ? 'is-invalid' : ''; ?>" id="duration_minutes" name="duration_minutes" value="<?php echo isset($data['duration_minutes']) ? $data['duration_minutes'] : ''; ?>" min="1" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control <?php echo !empty($data['sort_order_err']) ? 'is-invalid' : ''; ?>" id="sort_order" name="sort_order" value="<?php echo isset($data['sort_order']) ? $data['sort_order'] : '1'; ?>" min="0" required>
                        ...
                        <div class="text-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Lưu bài học</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Số thứ tự càng nhỏ sẽ hiển thị càng trước. Bài học đầu tiên nên có số thứ tự là 1.</p>
                </div>
            </div>
        </div>
    </div>
