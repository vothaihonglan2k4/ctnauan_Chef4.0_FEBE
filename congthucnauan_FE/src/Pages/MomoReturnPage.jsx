...
export default function MomoReturnPage() {
    ...
    const handleReturn = async () => {
        try {
            ...
            const response = await fetch(`/api/v1/momo/return?${queryString}`, {
                headers: {
            ...
            setResult({
                success: false,
                message: 'Có lỗi xảy ra khi xác thực thanh toán MoMo'
            });
        } finally {
            setLoading(false);
        }
        ...
        return (
            <div className="container mt-5">
                <div className="text-center py-5">
                    ...
                    <p className="mt-3">Đang xác thực thanh toán MoMo...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="col-md-6">
                        <div className="card border-success">
                            <div className="card-body text-center py-5">
                                ...
                                <p className="lead">Cảm ơn bạn đã thanh toán qua MoMo</p>
                ...
                <div className="col-md-6">
                    <div className="card border-danger">
                        <div className="card-body text-center py-5">
                            ...
                            {result.result_code !== undefined && (
                                <div className="alert alert-warning mt-3">
                                    <small>Mã lỗi: {result.result_code}</small>
                                </div>
                            )}
