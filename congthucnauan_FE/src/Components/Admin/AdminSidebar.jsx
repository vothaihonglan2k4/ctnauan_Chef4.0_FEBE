...
export default function AdminSidebar({ isOpen, onClose }) {
    ...
    const hasPermission = (permissionCode) => {
        ...
        if (user.role === 'admin') return true; // Admin có full quyền
        return user.permissions && user.permissions.includes(permissionCode);
    };

    const navItems = [
        { path: '/admin', icon: 'fas fa-tachometer-alt', label: 'Bảng điều khiển', exact: true, permission: null },
        { path: '/admin/users', icon: 'fas fa-users', label: 'Quản lý người dùng', permission: 'user.view' },
        { path: '/admin/permissions', icon: 'fas fa-shield-alt', label: 'Phân quyền', permission: 'rbac.manage' },
        { path: '/admin/categories', icon: 'fas fa-folder', label: 'Quản lý danh mục', permission: 'category.view' },
        { path: '/recipes', icon: 'fas fa-utensils', label: 'Quản lý công thức', permission: 'recipe.view' },
        { path: '/admin/courses', icon: 'fas fa-chalkboard-teacher', label: 'Quản lý khóa học', permission: 'course.view' },
        { path: '/admin/classrooms', icon: 'fas fa-door-open', label: 'Quản lý phòng học', permission: 'classroom.view' },
        { path: '/admin/payments', icon: 'fas fa-money-bill-wave', label: 'Quản lý thanh toán', permission: 'payment.view' },
        { path: '/admin/contacts', icon: 'fas fa-envelope', label: 'Quản lý liên hệ', permission: 'contact.view' },
        { path: '/admin/reports', icon: 'fas fa-chart-bar', label: 'Báo cáo & Thống kê', permission: 'report.view' },
    ];
